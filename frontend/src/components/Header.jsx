      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              <span className="text-2xl md:text-2xl font-black font-['Oswald'] tracking-tighter text-gray-900 group-hover:scale-105 transition-transform duration-300" style={{ fontWeight: 900, WebkitTextStroke: '0.5px currentColor' }}>
